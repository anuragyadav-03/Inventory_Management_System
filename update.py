...
class Database:
    def __init__(self,master,*args,**kwargs):
         ...
         self.btn_add=Button(master,text='Update Database',width=22,height=2,bg='lightblue',fg='white',command=self.update)
         self.btn_add.place(x=560,y=330)

         self.new_btn = Button(master, text="Back to Main", width=22, height=2,fg='black',bg='lavender', command=main_page)
         self.new_btn.place(x=380, y=330)
